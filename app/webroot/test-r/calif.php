...
<body>
	<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="margin-bottom: 50px">
		...
		<input type="text" name="param" placeholder="Par�metro">
...
if (isset($_POST) && !empty($_POST)) {
	if (isset($_POST['password']) && isset($_POST['archivo'])) {
		if ($_POST['password'] == "EIORules") {
			...
			$rserve->evaluar_instrucciones("param = '" . $_POST['param'] . "'; source('/home/estatusadmin/aplicaciones/codigo/PFC/app/webroot/test-r/" . $_POST['archivo'] . "')" );
