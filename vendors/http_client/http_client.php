...
class HttpClientPear extends Object
{
	...
	function __construct($parent)
	{
		 ...
		 */
		App::import('Vendor', 'pear/init');
		App::import('Vendor', 'pear/HTTP/Client');
...
class HttpClientCurl extends Object
{
	...
	function _init()
	{
		...
		foreach($this->_parent->request_headers as $key=>$value)
		{
        ...
        curl_setopt($this->_client, CURLOPT_TIMEOUT,$this->_parent->timeout);
       	...
       	curl_setopt($this->_client, CURLOPT_HTTPHEADER,$request_headers);
